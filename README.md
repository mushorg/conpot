...
[![Docs](https://readthedocs.org/projects/conpot/badge/?version=latest)](http://conpot.readthedocs.io/en/latest/)
...
The build of the documentations [source](https://github.com/mushorg/conpot/tree/master/docs/source) can be found [here](http://conpot.readthedocs.io/en/latest/). There you will also find the instructions on how to [install](http://conpot.readthedocs.io/en/latest/installation/ubuntu.html) conpot and the [FAQ](http://conpot.readthedocs.io/en/latest/faq.html).
